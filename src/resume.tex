...
\section{Summary}
Software Engineer with 5+ years of experience owning features end-to-end — from architecture and implementation to A/B experiment rollout in production. Specialized in generative AI integration, frontend performance engineering, and building agentic AI tooling that automates software development workflows. Currently at Adobe Express, delivering features to 100M+ users worldwide.
\sectionsep
